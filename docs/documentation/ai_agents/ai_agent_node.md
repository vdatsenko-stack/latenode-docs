...
![CleanShot 2025-05-16 at 18.38.18.png](./ai_agent_node/cleanshot_20250516_at_18.38.18.png)
...
![brave_fvEXfL38jp.png](./ai_agent_node/brave_68ln7zaoqd.png)
...
![brave_xNNZGPqEGq.png](./ai_agent_node/brave_68ln7zaoqd.png)
...
![brave_9uh4VMBrnf.png](./ai_agent_node/brave_68ln7zaoqd.png)
...
- **Tool metadata** — each connected node must provide:
    ...
    ![brave_oShdIMhDhh.png](./ai_agent_node/brave_68ln7zaoqd.png)
...
![brave_sIdzBuBDiw.png](./ai_agent_node/brave_68ln7zaoqd.png)
...
![brave_ZlaQrPlTp8.png](./ai_agent_node/brave_68ln7zaoqd.png)
...
![brave_xiqvZfU4oX.png](./ai_agent_node/brave_68ln7zaoqd.png)
...
![brave_h72MlkiWPY.png](./ai_agent_node/brave_68ln7zaoqd.png)
...
![brave_dhJzbkPo2S.png](./ai_agent_node/brave_68ln7zaoqd.png)
...
![brave_ahtqYMQUqg.png](./ai_agent_node/brave_68ln7zaoqd.png)
...
![brave_kclShZkQHU.png](./ai_agent_node/brave_68ln7zaoqd.png)
...
![brave_68lN7zAoQd.png](./ai_agent_node/brave_68ln7zaoqd.png)

- If the user asks to create note, it uses the `Create Note`node.

![brave_cua2kt18nf.png](./ai_agent_node/brave_68ln7zaoqd.png)
...
![brave_lL4T52yY0g.png](./ai_agent_node/brave_68ln7zaoqd.png)
...
![brave_TStf2Ey04h.png](./ai_agent_node/brave_68ln7zaoqd.png)
