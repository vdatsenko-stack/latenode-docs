...
![brave\_Qyymm7pVG9](/placeholder.png)

* Click **Save** and **Run once** to pass the data into the scenario.

![brave\_adWork9YBa](/placeholder.png)
...
![brave\_fNDpJbftqJ](/placeholder.png)

* Run the scenario.
* The output will be the formatted text.

![brave\_cZ7vEmRyUD](/placeholder.png)
